...
def main():
		simulation_time = [10, 100, 1000, 10000, 100000, 1000000, 10000000]
		lambda_list = [0.2, 0.4, 0.6, 0.8, 0.9, 0.99]
		buffer_list = [10, 50]
		for simtime in simulation_time:
		  	print("Simulation Time: {0}".format(simtime))
		  	for buffer in buffer_list:
		  		print("Simple queue system model:mu = {0}, Buffer: {1}".format(MU, buffer))
		  		random.seed(RANDOM_SEED)
		  		print("{0:<9} {1:<9} {2:<9} {3:<9}".format("Lambda", "Probability", 
						"Pckt Loss", "Total Pckt"))
		  		for arrival_rate in lambda_list:
		  			...
		  			print("{0:<9} {1:<9.9f} {2:<9} {3:<9}".format(arrival_rate, round(router.packet_loss()/router.packet_count(), 9), router.packet_loss(), router.packet_count()))
